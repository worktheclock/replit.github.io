...
![**Image 1:** *Forking another user's project*](https://i.ritzastatic.com/repl/codewithrepl/05-multiplayer/05-01-fork-repl.png)

Now from your own fork, press the `share` button, as shown below.

![**Image 2:** *Sharing your project with another user*](https://i.ritzastatic.com/repl/codewithrepl/05-multiplayer/05-02-share-repl.png)
...
![**Image 3:** *Sharing options modal*](https://i.ritzastatic.com/repl/codewithrepl/05-multiplayer/05-03-share-link.png)
...
![**Image 4:** *Starting chat with another user*](https://i.ritzastatic.com/repl/codewithrepl/05-multiplayer/05-04-team-chat.png)
...
![**Image 5:** *Chat box showing that user is typing*](https://i.ritzastatic.com/repl/codewithrepl/05-multiplayer/05-05-typing-indicator.png)
...
![**Image 6:** *Changing the plot from grouping data by country to grouping by continent*](https://i.ritzastatic.com/repl/codewithrepl/05-multiplayer/05-06-add-hue-continent.png)
...
![**Image 7:** *You can move the chat box to the left of the IDE to see errors better*](https://i.ritzastatic.com/repl/codewithrepl/05-multiplayer/05-07-move-chatbox.png)
...
![**Image 8:** *In our new plot, we can see that African countries tend to have low life expectency and low GDP, but the correlation looks weaker for the other continents*](https://i.ritzastatic.com/repl/codewithrepl/05-multiplayer/05-08-figure-one.png)
